...
int main(){
    ...
    // e2.value = 2;
    // e2.time = 2;
    // cout << compare_egde(e1,e2) << endl;
    // add_edge(e2);
    // add_edge(e1);
    // for(int i = 0; i < 10000; i++){
    //     float r = (rand()+1)/(float)(RAND_MAX+1);
    //     cout << r << " ";
    // }
    // set<int> s1{1,4,5,6,7};
    // set<int> s2{1,5,8,9};
    // set<int> s3;
    ...
    // int i4 = 4;
    // cout << (23 << 16) + 13 << endl;
    // cout << allocate(370899, 2077,160000);
    // cout << allocate_value(7083008,8) << endl;
    // cout << allocate(i3,i4,10);
    // cout << allocate(i1,i3,10);
}